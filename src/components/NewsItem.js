        ...
        <div className="card mb-3" style={{ width: "62rem" }}>
          <div className='row g-0'>
            <div className='col-md-3'>
              <img src={imageUrl ? imageUrl : "https://www.vskills.in/certification/blog/wp-content/uploads/2015/01/structure-of-a-news-report.jpg"} className="card-img-top" alt="..." style={{ height: "14rem" }} />
            </div>
